This is a comprehensive blueprint for REAVO. The design aesthetic you’ve chosen—Neo-Brutalism light (lavender, lemon green, white space, and thin black borders)—will give it a modern, high-end "Fintech-Terminal" feel that stands out from boring legacy accounting software.
...
2. Lender funds a "Verification Wallet."
3. Lender calls GET /verify-employee/[UPID].
4. The API Response:
